...
## Matrix Plot
- **Descripción:** Tipo de gráfico que permite visualizar datos que puedan representarse en formato de matriz. Las filas y columnas de la matriz representan dos variables, que pueden ser numéricas o categóricas, mientras que el valor de cada celda representa el valor para ese punto de la matriz. Se pueden representar matrices de correlación, matrices de distancias o mapas de calor.
- **Ejemplos:**
- **Tipos de datos:** Numéricos y categóricos. Debe haber al menos una variable categórica.
